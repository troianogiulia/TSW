<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	if(categorie == null) {
		response.sendRedirect("./home?page=Giocattoli.jsp");	
		return;
	}
%>
<!DOCTYPE html>
...
<%@ include file="../fragments/header.jsp" %>
	...
	<%
	ArrayList<ProdottoBean> giocattoli = categorie.get(4);%>
	
	<div id="main" class="clear">
	
	<h2>GIOCHI E GIOCATTOLI</h2>
	
		<%
			if (giocattoli != null && giocattoli.size() != 0) {
				Iterator<?> it = giocattoli.iterator();
				while (it.hasNext()) {
		...
		<div class="item">
			...
			<li><a href="carrello?action=addC&id=<%=bean.getIdProdotto()%>&page=Giocattoli.jsp"><button>Aggiungi al carrello</button></a></li>
		 </ul>
		</div>
		<%
				}
