<%@page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	if(categorie == null) {
		response.sendRedirect("./home?page=Gioielli.jsp");	
		return;
	}
%>
<!DOCTYPE html>
...
<%@ include file="../fragments/header.jsp" %>
	...
	<%
	ArrayList<ProdottoBean> gioielli = categorie.get(3);%>
	...
	<h2>GIOIELLI</h2>
		...
		<%
			if (gioielli != null && gioielli.size() != 0) {
				Iterator<?> it = gioielli.iterator();
				while (it.hasNext()) {
		...
		<div class="item">
			...
			<li><a href="carrello?action=addC&id=<%=bean.getIdProdotto()%>&page=Gioielli.jsp"><button>Aggiungi al carrello</button></a></li>
		 </ul>
		</div>
		<%
				}
