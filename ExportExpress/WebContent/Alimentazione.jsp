<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	if(categorie == null) {
		response.sendRedirect("./home?page=Alimentazione.jsp");	
		return;
	}
%>
<!DOCTYPE html>
...
<%@ include file="../fragments/header.jsp" %>
	...
	<%
	ArrayList<ProdottoBean> alimentazione = categorie.get(0);%>
	...
	<h2>ALIMENTAZIONE</h2>
		...
		<%
			if (alimentazione != null && alimentazione.size() != 0) {
				Iterator<?> it = alimentazione.iterator();
				while (it.hasNext()) {
		...
		<div class="item">
			...
			<li><a href="carrello?action=addC&id=<%=bean.getIdProdotto()%>&page=Alimentazione.jsp"><button>Aggiungi al carrello</button></a></li>
		 </ul>
		</div>
		<%
				}
